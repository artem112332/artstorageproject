    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, upload_to=artstorage.models.user_directory_path, verbose_name='Фото')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('project_watch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artstorage.project', verbose_name='Проект')),
                ('user_watch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Проект')),
            ],
        ),
        migrations.CreateModel(
            name='Like',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('project_liked', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artstorage.project', verbose_name='Проект')),
                ('user_liked', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='юзер')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
